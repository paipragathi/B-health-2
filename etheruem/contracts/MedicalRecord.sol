...
contract MedicalRecord{
    ...
    event PatientAdded(
        string uhid , string name,  string phone ,string email ,string gender, string dob ,string height, string weight, string houseAddress, string bloodGroup,
        string allergies, string emergencyName,  string emergencyContact, address walletAddress
    );

    event PatientUpdated(
        string name, string phone , string gender , string dob, string height,  string weight, string houseAddress, string bloodGroup ,
        string allergies, string emergencyName, string emergencyContact, address walletAddress
    );
   ...
   //allow patients to edit theit existing records
    function editPatientDetails(
        string memory _name, string memory _phone, string memory _gender, string memory _dob, string memory _height, string memory _weight, string memory _houseaddr, string memory _bloodgroup, string memory _allergies,  string memory _emergencyName, string memory _emergencyContact
    ) public{
